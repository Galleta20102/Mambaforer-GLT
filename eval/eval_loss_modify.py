...
# Import Directly # m11215021
import my_modify.cape_mambaformer_Res_smth_struct_05_orgCAPE_m2 as mambaformer
from models import StyTR

# ====== VMambaformer ======
# sys.path.append(os.path.dirname(os.path.abspath(__file__)))
# sys.path.append("my_modify")
# import my_modify.VSSMformer_pure_res_smth_struct as VSSMformer
# import models.StyTR_VMambaformer_edge_gradLoss  as StyTR
...
def load_pretrained(args):
    ...
    Trans = mambaformer.cape_mambaformer() # m11215021
    # Trans = mambast_trans.Mamba(args=args)# for mamba-st
